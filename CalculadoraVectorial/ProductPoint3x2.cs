...
{
    public partial class ProductPoint3x2 : Form
    {
        public ProductPoint3x2()
        {
            InitializeComponent();
        }
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                "\nu = [ x1 (i), y1 (j) ], v = [ x2 (i), y2 (j) ] y w = [ x3 (i), y3 (j) ]" +
                "\n\n\nTendriamos como resultado " +
                "\nu = [ x1 ( " + ui + "i ), y1 ( " + uj + "j ) ] y v = [ x2 ( " + vi + "i ), y2 ( " + vj + "j ) ],  w = [ x3 ( " + wi + "i ), y3 ( " + wj + "j ) ]" +
